export type MongoValueType = any
...
export interface MongoCommandUpdateOption<T extends MongoRawDocument> {
...
export interface MongoCommandDeleteOption {
...
export interface MongoCommandFindOption<T extends MongoRawDocument> {
 ...
 */
export interface MongoCommandFindAndModifyOption<T extends MongoRawDocument> {
...
export interface MongoCommandInsertOption<T extends MongoRawDocument> {
